// nexrad-level-2-data ships no types. Only the surface this project actually
// uses is declared here — see node_modules/nexrad-level-2-data/API.md for
// the full API if more of it is needed later.
