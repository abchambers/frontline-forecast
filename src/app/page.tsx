  ...
  return (
    <main className={`${radarExpanded ? "app radar-expanded" : "app"} desk-${activeWorkspace?.kind ?? "public"}`}>
      <header className="header">
        <div className="brand-lockup"><img src="/brand/frontline-forecast-mark.png" alt="" /><div><img className="brand-wordmark" src="/brand/frontline-forecast-wordmark.png" alt="Frontline Forecast" /><p className="eyebrow" data-hq-content="brand.tagline">Human-first forecasting workspace</p></div></div>
