...
const radarSourceLabels: Record<"nexrad" | "gribstream" | "provider", string> = {
  nexrad: "NEXRAD Level II (in-house)",
  gribstream: "MRMS (GribStream)",
  provider: "NWS/NEXRAD",
};
...
export default function Home() {
  ...
  const [radarSource, setRadarSource] = useState<"nexrad" | "gribstream" | "provider" | null>(null);
