  ...
  return (
    ...
    <main className={`app desk-${activeWorkspace?.kind ?? "public"}`}>
      ...
      {activeSection === "radar" && <section className="radar-workspace">
        ...
        {(radarMapView !== "future_reflectivity" || hasForecasterToolsAccess) && <RadarLegendStrip view={radarMapView} inline elevationDeg={radarFrameMeta?.elevationDeg ?? null} observedAtLabel={radarObservedAtLabel} />}
