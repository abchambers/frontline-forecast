    ...
    <main className={radarExpanded ? "app radar-expanded" : "app"}>
      ...
      <section className="data-desk">
        ...
        {dataPanel === "models" && <section className="model-workspace">
          ...
          <div className="model-workflow"><div><strong>1. Start with the pattern</strong><span>Use Global for the broad range and timing beyond the near term.</span></div><div><strong>2. Refine the local forecast</strong><span>Use High-res guidance for Athens-scale temperature, PoP, wind, and convective detail.</span></div><div><strong>3. Test the environment</strong><span>Open the model sounding before committing to a severe-weather or instability call.</span><button type="button" onClick={() => setDataPanel("model-sounding")}>Open sounding</button></div></div>
