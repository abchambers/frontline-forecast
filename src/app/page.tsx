...
export default function Home() {
  ...
  return (
    ...
    <main className={`app desk-${activeWorkspace?.kind ?? "public"}`}>
      ...
      {activeSection === "control" && session && !isFirstRunSetup && <div className="section-heading"><div><p className="eyebrow">Account</p><h2>Settings</h2><p>Your profile, plan, and how Frontline Forecast looks and opens for you.</p></div></div>}
