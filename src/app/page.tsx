  ...
  return (
    <main className={`${radarExpanded ? "app radar-expanded" : "app"} desk-${activeWorkspace?.kind ?? "public"}`}>
      <header className="header">
        <div className="brand-lockup"><img src="/brand/frontline-forecast-mark.svg" alt="" /><div><p className="eyebrow" data-hq-content="brand.tagline">Human-first forecasting workspace</p><h1 data-hq-content="brand.name">Frontline Forecast</h1></div></div>
