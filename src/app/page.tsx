  ...
  return (
    <main className={`${radarExpanded ? "app radar-expanded" : "app"} desk-${activeWorkspace?.kind ?? "public"}`}>
      <header className="header">
        <div className="brand-lockup"><img className="official-brand-logo" src="/brand/frontline-forecast-official.svg" alt="Frontline Forecast" /><div><p className="eyebrow" data-hq-content="brand.tagline">Human-first forecasting workspace</p></div></div>
