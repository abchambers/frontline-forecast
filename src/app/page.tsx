  ...
  return (
    <main className={`${radarExpanded ? "app radar-expanded" : "app"} desk-${activeWorkspace?.kind ?? "public"}`}>
      <header className="header">
        <div className="brand-lockup"><img src="/brand/frontline-forecast-emblem.svg" alt="" /><div><strong className="brand-name">Frontline Forecast</strong><p className="eyebrow" data-hq-content="brand.tagline">Human-first forecasting workspace</p></div></div>
