    ...
    (
      <div style={{ alignItems: "center", background: "#08054e", color: "#f8f9ff", display: "flex", height: "100%", padding: "76px", width: "100%" }}>
        <div style={{ alignItems: "center", display: "flex", gap: "32px" }}>
          <div style={{ alignItems: "center", background: "#f8f9ff", border: "4px solid #72c8f7", borderRadius: "42px", display: "flex", height: "180px", justifyContent: "center", position: "relative", width: "180px" }}>
