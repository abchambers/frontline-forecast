...
// SPC's Day 1 categorical convective outlook GeoJSON already carries stroke/fill colors and
// human-readable risk labels per feature, so this is a thin proxy rather than a transform.
const SOURCE_URL = "https://www.spc.noaa.gov/products/outlook/day1otlk_cat.nolyr.geojson";
